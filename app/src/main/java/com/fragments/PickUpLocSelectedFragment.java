...
//    ImageView addDestLocImgView;
//    LinearLayout destLocArea;
...
//        addDestLocImgView = (ImageView) view.findViewById(R.id.addDestLocImgView);
//        destLocArea = (LinearLayout) view.findViewById(R.id.destLocArea);
...
//        addDestLocImgView.setOnClickListener(new setOnClickList());
...
//        new CreateRoundedView(Color.parseColor("#CCe0e0e0"), Utils.dipToPixels(getActContext(), 0), Utils.dipToPixels(getActContext(), 0),
